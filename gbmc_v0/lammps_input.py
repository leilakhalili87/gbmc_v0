...
def write_lammps_script(lat_par, dump_name, path, script_name,  box_bound, box_type):
    ...
    line.append('reset_timestep 0\n')
    line.append('timestep 0.001\n')
    line.append('fix 1 all npt temp .1 466.75 0.1 couple xy  x 0.0 0.0 1.0  y 0.0 0.0 1.0\n')
    line.append('thermo 10\n')
    ...
    line.append('reset_timestep 0\n')
    line.append('timestep 0.001\n')
    line.append('fix 1 all npt temp 466.75 .1 0.1 couple xy  x 0.0 0.0 1.0  y 0.0 0.0 1.0\n')
    line.append('thermo 10\n')
    line.append('thermo_style custom step temp pe lx ly lz press pxx pyy pzz c_eatoms\n')
